                     ...
                     AutoCloseable
{
  ...
  public String toString()
  {
    ...
    for (int i = 0; i < dim; i++)
    {
      ...
      sb.append(String.format("%s %si", get(i).getReal(), get(i).getImag()));
    }
    sb.append("]");
    return sb.toString();
  }
  ...
  {
    assert index < dim;
    return new Complex(swigCPtr + index * Complex.BYTES,
                       false);
  }
   ...
   * 
   * @return the unique polynomial of length at most n that interpolates the given
   *         x and y values. This implementation first interpolates in the Newton
   *         basis and then converts back to the monomial basis.
   */
  public ComplexPolynomial interpolate(Complex y, int n, int prec, ComplexPolynomial result)
  {
    arblib.acb_poly_interpolate_newton(result, this, y, n, prec);
    return result;
  }
